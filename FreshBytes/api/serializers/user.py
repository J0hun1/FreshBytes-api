...
class UserListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = [
            'user_id', 'user_name', 'full_name', 'user_email', 'role',
            'is_active', 'is_deleted', 'created_at', 'created_date'
        ]
        read_only_fields = ['user_id', 'created_at', 'full_name', 'created_date']
...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['user_id', 'user_name', 'first_name', 'last_name', 'full_name', 'user_email', 
                 'password', 'user_phone', 'street', 'barangay', 'city', 'province', 'zip_code','role', 'created_at', 'updated_at', 'created_date', 'updated_date', 'is_active', 'is_deleted', 
                 'is_staff', 'is_superuser', 'terms_accepted', 'phone_verified', 'email_verified']
        read_only_fields = ['user_id', 'created_at', 'updated_at', 'full_name', 'created_date', 'updated_date']
        extra_kwargs = {
